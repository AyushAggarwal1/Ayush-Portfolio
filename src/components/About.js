...
const About = () => {
  return (
    <section id="about" className="about-section">
      <p className="intro-line  fade-in"> I’m Ayush, dedicated to continuous learning and exploration, enthusiastic learner with a passion for discovering new ideas and experiences.</p>
      <h2 className="underline"><FaUserCircle /> About Me</h2>
